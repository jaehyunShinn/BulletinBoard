...
import com.nextcode.board.mapper.UserMapper;
...
@RestController
@RequestMapping("/user")
public class UserLoginController extends {
    @Autowired
    private UserService sqlsession;
...
//        model.addAttribute("loginError", true);
         ...
         */
        UserService userService = new UserMapper();
        //login 이후에 세션이 만들어짐
